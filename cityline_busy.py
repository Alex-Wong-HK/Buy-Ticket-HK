...
if browser == "chrome":
    ...
    chromedriver_path =Root_Dir+ "/Users/shing/Downloads/chromedriver"
...
def main():
    driver.get('http://event.cityline.com/utsvInternet/MFANIRO/login')
    ...
    while True:
        ...
        if 'http://msg.cityline.com/' in url:
            driver.get('http://event.cityline.com/utsvInternet/MFANIRO/login')
        # if 'https://venue.cityline.com/utsvInternet/MFANIRO/login' in url:
        #     driver.get('http://event.cityline.com/utsvInternet/MFANIRO/login')
